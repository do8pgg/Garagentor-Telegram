/*
   Copyright (c) 2021-2024 do8pgg. All rights reserved.
    ...
    */
    /* // /hilfe
        if (text == "/hilfe")
        {
          ...
          welcome += " \n";
          welcome += "'tor' 'an' und 'aus' sind auch ohne '/' mÃ¶glich. \n";
          bot.sendMessage(chat_id, welcome, "Markdown");
        }
    */
    /* // status
...
void ntp() {
  // NTP-Zeiten beziehen fÃ¼r Telegram-Cert...
